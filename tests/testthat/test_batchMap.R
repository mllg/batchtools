...
test_that("batchMap", {
  ...
  expect_equal(readRDS(reg$uri$files[["user.function"]]), fun)
  expect_equal(readRDS(reg$uri$files[["more.args"]]), list(x = 1))
  ...
  expect_equal(readRDS(reg$uri$files[["more.args"]]), list(j = 1))
