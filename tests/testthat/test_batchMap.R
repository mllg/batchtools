...
test_that("batchMap", {
  ...
  expect_equal(readRDS(reg$path$file["user.function"]), fun)
  expect_equal(readRDS(reg$path$file["more.args"]), list(x = 1))
  ...
  expect_equal(readRDS(reg$path$file["more.args"]), list(j = 1))
