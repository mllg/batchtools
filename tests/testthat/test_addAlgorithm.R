...
test_that("addAlgorithm", {
  ...
  expect_file_exists(getAlgorithmURI(reg$file.dir, algo$name))
  ...
  expect_false(file.exists(getAlgorithmURI(reg$file.dir, "a1")))
  expect_true(file.exists(getAlgorithmURI(reg$file.dir, "a2")))
