...
getErrorMessages()
```
If we want to peek into the R log file of a job to see more context for the error we can use [`showLog()`](https://mllg.github.io/batchtools/showLog.html) which opens a pager or use [`getLog()`](https://mllg.github.io/batchtools/showLog.html) to get the log as character vector:
```{r}
